...
return static function (ContainerConfigurator $container) {
    $container
        ...
        ->set('ekyna_resource.form_type_extension.decimal', DecimalTypeExtension::class)
            ->tag('form.type_extension')

        // Constant choice form type
        ->set('ekyna_resource.form_type.constant_choice', ConstantChoiceType::class)
            ->args([
                service('translator'),
            ])
            ->tag('form.type')
        ...
        ->set('ekyna_resource.form_type.locale_choice', LocaleChoiceType::class)
            ->args([
        ...
        ->set('ekyna_resource.form_type.resource_search', ResourceSearchType::class)
            ->args([
                service('ekyna_resource.helper'),
                service('ekyna_resource.repository.factory'),
                service('serializer'),
